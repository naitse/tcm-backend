package com.mulesoft.pusher.util;
...
public class PusherUtil {
     ...
     * @return
     */
    public static String buildChannelURIPath(String channelName, String pusherApplicationId){
    	StringBuffer buffer = new StringBuffer();
    	//Application ID
    	buffer.append("/apps/");
    	buffer.append(pusherApplicationId);
     ...
     * @return
     */
    public static String buildGetAuthenticationSignature(String uriPath, String query, String pusherApplicationSecret){
    	StringBuffer buffer = new StringBuffer();
    	//request method
    	buffer.append("GET\n");
    	//URI Path
